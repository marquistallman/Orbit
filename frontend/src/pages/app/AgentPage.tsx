...
export default function AgentPage() {
  ...
  return (
    <div style={{
      ...
      <DashCard style={{ padding: '16px 18px' }} speed={0.00035}>
        <div style={{ fontSize: 10, color: '#8C6A3E', marginBottom: 8, textTransform: 'uppercase' as const }}>
          Last execution
        </div>
        {!result ? (
          ...
          <>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
              <span style={{
                fontSize: 10, border: `1px solid ${toolBadgeColor}66`,
                color: toolBadgeColor, borderRadius: 999, padding: '2px 8px',
              }}>
            ...
            <div style={{
              fontSize: 13, color: '#EDE6D6', lineHeight: 1.7,
